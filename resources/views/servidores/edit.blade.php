...
<div class="container mx-auto p-4 max-w-md">
  <h1 class="text-2xl font-bold mb-4 text-gray-100">Editar Servidor</h1>

  <form action="{{ route('servidores.update', $servidor['id']) }}"
        method="POST"
        class="space-y-4">
    @csrf
    @method('PUT')
    ...
    <div>
      ...
      <input name="guild_id"
             value="{{ old('guild_id', $servidor['guild_id']) }}"
    ...
    <div>
      ...
      <input name="nome_servidor"
             value="{{ old('nome_servidor', $servidor['nome_servidor']) }}"
    ...
    <div>
      ...
      <input name="admin_discord_id"
             value="{{ old('admin_discord_id', $servidor['admin_discord_id']) }}"
